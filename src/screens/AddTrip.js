    ...
    <div className="add-trip-container">
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div className="shared-line">
            ...
            <label htmlFor="subclub">Subclub:</label>
            <select name="subclub" value={formData.subclub} onChange={handleChange} required className="form-input">
              <option value="">Select a Subclub</option>
              {subclubs.map(subclub => (
                <option key={subclub.id} value={subclub.id}>{subclub.subclub_name}</option>
              ))}
          ...
          <div className="shared-line">
            <div className="form-question" id="trip-type-group">
              <label className='form-label'>Trip Type</label>
              <select name="trip_type" value={formData.trip_type} onChange={handleChange} required className="form-input">
            ...
            <div className="form-question" id="trip-level-group">
              <label className='form-label'>Trip Level</label>
              <select name="trip_level" value={formData.trip_level} onChange={handleChange} required className="form-input">
          ...
          <div className="form-question">
            ...
            <textarea className="form-input" id="what-to-bring" name="trip_bring" value={formData.trip_bring} onChange={handleChange} />
          </div>
          <div className="form-question">
